...
import static com.ke.webview.ke_flutter_webview.KeFlutterWebviewPlugin.registrar;

public class KeFlutterWebView extends WebView {

    static final String LOG_TAG = "InAppWebView";

    public FlutterWebView flutterWebView;
    int id;
    KeFlutterWebViewClient inAppWebViewClient;
    KeFlutterWebChromeClient inAppWebChromeClient;
    ...
    public KeFlutterWebView(Context context) {
        super(context);
    }

    public KeFlutterWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public KeFlutterWebView(Context context, AttributeSet attrs, int defaultStyle) {
        super(context, attrs, defaultStyle);
    }

    public KeFlutterWebView(Context context, Object obj, int id, InAppWebViewOptions options) {
        super(context);
    ...
    public void prepare() {
        ...
        addJavascriptInterface(new JavaScriptBridgeInterface(flutterWebView), JavaScriptBridgeInterface.name);

        inAppWebChromeClient = new KeFlutterWebChromeClient(flutterWebView);
        setWebChromeClient(inAppWebChromeClient);

        inAppWebViewClient = new KeFlutterWebViewClient(flutterWebView);
...
//            settings.setMediaPlaybackRequiresUserGesture(newOptions.mediaPlaybackRequiresUserGesture);
    ...
    public void injectDeferredObject(String source, String jsWrapper, final MethodChannel.Result result) {
        ...
        flutterWebView.activity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
