...
public class FlutterWebView implements PlatformView, MethodCallHandler  {
    ...
    public KeFlutterWebView webView;
    ...
    public FlutterWebView(Registrar registrar, int id, HashMap<String, Object> params) {
        ...
        webView = new KeFlutterWebView(context, this, id, options);
        webView.prepare();

        channel = new MethodChannel(registrar.messenger(), "com.ke/flutter_webview_" + id);
