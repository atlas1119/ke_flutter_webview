...
public class KeFlutterWebViewClient extends WebViewClient{
...
//    private InAppBrowserActivity inAppBrowserActivity;
    ...
    public KeFlutterWebViewClient(Object obj) {
        super();
    ...
    public boolean shouldOverrideUrlLoading(WebView webView, String url) {
        ...
        if (flutterWebView.webView.options.useShouldOverrideUrlLoading) {
        ...
        if (url.startsWith(WebView.SCHEME_TEL)) {
            try {
                ...
                flutterWebView.activity.startActivity(intent);
                return true;
    ...
    public void onPageStarted(WebView view, String url, Bitmap favicon) {
        ...
        flutterWebView.webView.isLoading = true;
    ...
    public void onPageFinished(WebView view, String url) {
        ...
        flutterWebView.webView.isLoading = false;
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            view.evaluateJavascript(KeFlutterWebView.consoleLogJS, null);
            view.evaluateJavascript(JavaScriptBridgeInterface.flutterInAppBroserJSClass, null);
        }
        else {
            view.loadUrl("javascript:"+KeFlutterWebView.consoleLogJS);
    ...
    public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
        if (!request.getMethod().toLowerCase().equals("get") ||
                !flutterWebView.webView.options.useOnLoadResource) {
            return null;
        }
        ...
        try {
            ...
            Response response = flutterWebView.webView.httpClient.newCall(mRequest).execute();
